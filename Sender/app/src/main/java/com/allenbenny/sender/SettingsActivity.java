...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if(resultCode == RESULT_OK){
                ...
                loadingBar.setMessage("We're updating your profile Picture");
    ...
    private void UpdateSettings() {
            ...
            if(TextUtils.isEmpty(setUserName)){
                Toast.makeText(SettingsActivity.this, "What should i call you ?", Toast.LENGTH_SHORT).show();
            }
            if(TextUtils.isEmpty(setUserStatus)){
                Toast.makeText(SettingsActivity.this, "What do i know about you ?", Toast.LENGTH_SHORT).show();
            }
            else {
        ...
        RootRef.child("Users").child(currentUserID).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if ((dataSnapshot.exists()) && (dataSnapshot.hasChild("name")) && (dataSnapshot.hasChild("image"))){
                    ...
                    Toast.makeText(SettingsActivity.this, "Set your Profile Info", Toast.LENGTH_SHORT).show();
                }
            }
